...
variable "secondary_private_ips" {
  description = "A list of Secondary private IP addresses which is selected from within the CIDR block of the VSwitch."
  type        = list(string)
  default     = null
}

variable "secondary_private_ip_address_count" {
  description = "The number of private IP addresses to be automatically assigned from within the CIDR block of the vswitch."
  type        = number
  default     = null
}
...
variable "ipv6_addresses" {
  description = "A list of IPv6 address to be assigned to the primary ENI. Support up to 10."
  type        = list(string)
  default     = []
}
