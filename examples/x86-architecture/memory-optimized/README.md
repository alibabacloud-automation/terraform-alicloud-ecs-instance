# x86-Architecture-Memory-Optimized ECS Instance example

Configuration in this directory creates set of x86-architecture-memory-optimized ECS instance resources.
