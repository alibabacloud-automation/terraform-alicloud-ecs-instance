# x86-Architecture-General-Purpose ECS Instance example

Configuration in this directory creates set of x86-architecture-general-purpose ECS instance resources.
