# x86-Architecture-Compute-Optimized ECS Instance example

Configuration in this directory creates set of x86-architecture-compute-optimized ECS instance resources.
