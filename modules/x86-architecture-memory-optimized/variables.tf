...
variable "instance_type_family" {
  description = "The instance type family used to retrieve bare metal CPU instance type. Valid values: [\"ecs.r6\", \"ecs.r5\", \"ecs.re4\"]"
  default     = "ecs.r6"
}
...
variable "tags" {
  ...
  default = {
    Created = "Terraform"
    Source  = "alibaba/ecs-instance/alicloud//modules/x86-architecture-memory-optimized"
  }
}
