...
variable "instance_type_family" {
  description = "The instance type family used to retrieve bare metal CPU instance type. Valid values: [\"ecs.d1ne\", \"ecs.d1\", \"ecs.d1-c8d3\", \"ecs.d1-c14d3\"]"
  default     = "ecs.d1ne"
}
...
variable "tags" {
  ...
  default = {
    Created = "Terraform"
    Source  = "alibaba/ecs-instance/alicloud//modules/x86-architecture-big-data"
  }
}
