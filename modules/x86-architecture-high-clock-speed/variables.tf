...
variable "instance_type_family" {
  description = "The instance type family used to retrieve bare metal CPU instance type. Valid values: [\"ecs.hfg6\", \"ecs.hfg5\", \"ecs.hfc5\"]"
  default     = "ecs.hfg6"
}
...
variable "tags" {
  ...
  default = {
    Created = "Terraform"
    Source  = "alibaba/ecs-instance/alicloud//modules/x86-architecture-high-clock-speed"
  }
}
