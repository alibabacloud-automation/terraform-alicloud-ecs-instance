...
locals {
  ...
  instance_type_families = ["ecs.i2g", "ecs.i2", "ecs.i1"]
}


data "alicloud_instance_types" "this" {
  instance_type_family = var.instance_type_family != "" && contains(local.instance_type_families, var.instance_type_family) ? var.instance_type_family : "ecs.i2g"
...
module "ecs-instance" {
  ...
  instance_name     = "TF-x86-architecture-local-ssd"
  use_num_suffix    = true
  tags              = var.tags
